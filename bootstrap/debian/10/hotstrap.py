...
def pip_down():
    ...
    try:
        for package in os_list:
            ...
            os.system('/etc/.rackspace_heat/bin/python -m pip3 install ' + package)
            print('Successful')
    except:
        print('Unsuccessful')
...
def configurate():
    ...
    for file in file_list:
        ...
        print('hotstrapper-staging/bootstrap/debian/10/' + file + '\t->\t' + '/' + file)
        shutil.move('hotstrapper-staging/bootstrap/debian/10/' + file, '/' + file)
    for i in range(3):
